    ...
    handleSubmit(e) {
        ...
        if (this.state.email && this.state.email.length > 0 && this.state.name && this.state.name.length > 5 ) {
          ...
          if (this.state.email.match(mailformat)) {
            ...
            xhr.open('POST', `https://app-3QNMWRHCZE.marketingautomation.services/webforms/receivePostback/MzawMLEwMjM1BQA/960bba77-86d8-45e0-9e09-dcbc00b16c71/jsonp/?firstName=${sharpName}&lastName=${sharplName}&email=${this.state.email}&trackingid__sb=${SharpSpringTracking}`);
            xhr.send()
    ...
    render() {
        return (
            ...
            <div className={'input__fields'}>
              ...
              <input type="text" id="lname" name="lname" onChange={this.handlelNameChange} value={this.state.lname} />   
              {
            ...
            <div>
             {
                ...
                ? "" 
                :<button disabled id={"submit__form"} className={"form__submit"} type="submit" onClick={this.handleSubmit} onKeyDown={this.handleSubmit}>
                    ...
                    <path d="M83.0001 29.333L116.881 29.333" stroke="#1C1A1B" strokeWidth="2"/>
                    <path d="M107.815 20.0146L117 29.3337L107.815 38.6527" stroke="#1C1A1B" strokeWidth="2"/>
                    </svg>
                </button>
              }
            </div>
            ...
            {
                this.state.formStatus
                ? <p className={"form__invalid form__response"}> Thanks for signing up to join the Humanified Beta Launch!</p>
                : ""
            }
            </div>
          </form> 
