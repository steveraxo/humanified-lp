      ...
      <section className="team__section team" id="meet-the-team">
        ...
        <div className="container">
          <div className="row team__row">
              ...
              <div className="team__row__one">
                <div className="team__member desktop">
                  ...
                  <MouseTooltip
                    ...
                    offsetY={-100}
                  >
                    <div className="team__member__info " id="team__oneone-member">
                      <div className="team__member__info__name">
                        <h5>
                          <span>Neil </span>
                          <span>St.Clair</span>
                ...
                <div className="team__member desktop">
                  ...
                  <MouseTooltip
                    ...
                    offsetY={-100}
                  >
                    <div className="team__member__info " id="team__twoone-member">
                      <div className="team__member__info__name">
                      <h5>
                          <span>Suren </span>
                ...
                <div className="team__member desktop">
                  ...
                  <MouseTooltip
                    ...
                    offsetY={-100}
                  >
                    <div className="team__member__info " id="team__threeone-member">
                      <div className="team__member__info__name">
                      <h5>
                          <span>Natalia
  </span>
              ...
              {/* Team members for Mobile */}
              <div className="team__member mobile">
                <div className="team__member__avatar" id="team__onesix-member" onClick={this.showInfoMobile}  onMouseEnter={this.showInfo} onMouseLeave={this.hideInfo}  >
                  {
                    images.map((image, index) =>
                      image.fluid.src.includes("neil.png")
                      ? <img src={image.fluid.src} alt="" key={index}  alt="Neil St.Clair, COO"/>
                ...
                <div className="team__member__info " id="team__onesix-membermobile">
                  <div className="team__member__info__name">
                  <h5>
                        <span>Neil </span>
                        <span>St.Clair</span>
              ...
              <div className="team__member mobile">
                ...
                <div className="team__member__info " id="team__twosix-membermobile">
                  <div className="team__member__info__name">
                  <h5>
                        <span>Suren </span>
                        <span>Sahaydachny</span>
              ...
              <div className="team__member mobile">
                ...
                <div className="team__member__info " id="team__threesix-membermobile">
                  <div className="team__member__info__name">
                    <h5>
                      <span>Natalia
</span>
